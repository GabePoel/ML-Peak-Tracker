...
tm.passive_class_train(name='simple_count', location=location, data_size=1000, scale=(0,1,1024), noise=True, epochs=10, model_design=model, steps=1, optimizer='adadelta')
